    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<out TextAttributesKey?> {
        ...
        return arrayOf(
            when (tokenType.antlrTokenType) {
                ...
                cqlLexer.T__74 -> KEYWORD // 'or'
                cqlLexer.T__75 -> KEYWORD // 'xor'
                ...
                cqlLexer.T__118 -> KEYWORD // 'div'
                cqlLexer.T__119 -> KEYWORD // 'mod'
