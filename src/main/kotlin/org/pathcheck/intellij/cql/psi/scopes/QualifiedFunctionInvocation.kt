 ...
 */
class QualifiedFunctionInvocation(node: ASTNode) : PsiContextNodes.QualifiedInvocation(node), ScopeNode, ReferenceLookupProvider {
    fun qualifiedFunction(): PsiContextNodes.QualifiedFunction? {
        return getRule(PsiContextNodes.QualifiedFunction::class.java, 0)
    }
