 ...
 */
class ExpressionDefSubtree(node: ASTNode, idElementType: IElementType) : IdentifierDefSubtree(node, idElementType),
    ...
    fun getExpressionName(): PsiElement? {
        return XPath.findAll(CqlLanguage, this, "/expressionDefinition/identifier").firstOrNull()
    }

    override fun lookup(): List<LookupElementBuilder> {
        return listOfNotNull(
            LookupHelper.build(
                getExpressionName()?.cleanText(),
